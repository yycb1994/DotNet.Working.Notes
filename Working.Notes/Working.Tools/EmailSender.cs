...
namespace Working.Tools
{
    ...
    public class EmailSender
    {
        ...
        /// <param name="subjectPrefix">邮件主题前缀</param>
        /// <param name="emailContext">邮件内容</param>
        public EmailSender(string smtpServer, int smtpPort, string senderName, string senderPassword, string subjectPrefix, string emailContext)
        {
        ...
        /// <param name="ccEmail">抄送邮箱地址</param>
        /// <param name="attachmentFilePath">附件文件路径</param>
        public void SendMail(string recipientEmail, string ccEmail, string attachmentFilePath = "")
            {
                try
                {
